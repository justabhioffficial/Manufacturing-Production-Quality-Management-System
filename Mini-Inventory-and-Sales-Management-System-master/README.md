# Manufacturing Production & Quality Management System
An Inventory and Production Management System written in PHP (CodeIgniter) with support for MySQL and Sqlite3 databases
...
- If you edit the folder name, you will need to do the following:
  - Open __.htaccess in the root folder__ and change the line with __"manufacturing-production-quality-management-system"__ to your new folder name. Leave it blank if app is directly inside your __www__ or __html__ directory.
