...
<head>
  <title><?= $pageTitle ?> | Manufacturing Production & Quality Management System</title>
...
<body>
  <nav class="navbar navbar-default hidden-print">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?= base_url() ?>" style="margin-top:-5px; font-size:13px; font-weight:bold; color:#333;">
          <i class="fa fa-industry"></i> MPQMS
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="nav navbar-nav navbar-left visible-xs">
          ...
          <?php if ($this->session->admin_role === "Super") : ?>
            ...
            <li class="<?= $pageTitle == 'Production Orders' ? 'active' : '' ?>">
              <a href="<?= site_url('production_orders') ?>">
                <i class="fa fa-clipboard"></i>
                Production Orders
              </a>
            </li>

            <li class="<?= $pageTitle == 'Machine Status' ? 'active' : '' ?>">
            ...
            <li class="<?= $pageTitle == 'Quality Inspection' ? 'active' : '' ?>">
              <a href="<?= site_url('quality_inspections') ?>">
                <i class="fa fa-check-circle"></i>
                Quality Inspection
              </a>
            </li>

            <li class="<?= $pageTitle == 'Daily Production Report' ? 'active' : '' ?>">
              <a href="<?= site_url('production_reports') ?>">
                <i class="fa fa-file-text"></i>
                Daily Production Report
              </a>
            </li>

            <li class="<?= $pageTitle == 'Shift-wise Production Dashboard' ? 'active' : '' ?>">
              <a href="<?= site_url('production_dashboard') ?>">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a>
              <i class="fa fa-industry"></i> <b>MPQMS</b> | Earned Today: <b>&#8358;<span id="totalEarnedToday"></span></b>
            </a>
          </li>
          <li class="dropdown">
  ...
  <div class="container-fluid hidden-print">
    <div class="row content">
      ...
      <div class="col-sm-2 sidenav hidden-xs mySideNav">
        <br>
        <p class="text-center" style="color:#777; font-size:10px; text-transform:uppercase; letter-spacing:1px; margin-bottom:10px;"><i class="fa fa-industry"></i> MPQMS</p>
        <ul class="nav nav-pills nav-stacked pointer">
          ...
          <?php if ($this->session->admin_role === "Super") : ?>
            ...
            <li style="margin-top:10px;">
              <a style="font-size:10px; color:#999; cursor:default; padding:5px 15px;"><i class="fa fa-industry"></i> MANUFACTURING</a>
            </li>
            ...
            <li style="margin-top:10px;">
              <a style="font-size:10px; color:#999; cursor:default; padding:5px 15px;"><i class="fa fa-bar-chart"></i> REPORTS</a>
            </li>
            ...
            <li style="margin-top:10px;">
              <a style="font-size:10px; color:#999; cursor:default; padding:5px 15px;"><i class="fa fa-wrench"></i> SYSTEM</a>
            </li>
  ...
  <footer class="container-fluid text-center hidden-print">
    <p>
      ...
      Manufacturing Production & Quality Management System &copy; <?= date('Y') ?>
    </p>
  </footer>
