...
<html lang="en">
    ...
    <head>
        ...
        <title>Manufacturing Production & Quality Management System - Log in</title>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div style="font-size:100px">
                                <h1 style="color:#fff; font-size:28px; font-weight:bold;"><i class="fa fa-industry"></i> MPQMS</h1>
                                <p style="color:rgba(255,255,255,0.7); font-size:14px; margin-top:-10px;">Manufacturing Production & Quality Management System</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
