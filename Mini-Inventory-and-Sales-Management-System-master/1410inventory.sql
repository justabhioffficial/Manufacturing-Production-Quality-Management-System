...
CREATE TABLE `production_orders` (
  ...
  `quantity_produced` int(10) NOT NULL DEFAULT 0,
...
CREATE TABLE `production_logs` (
  ...
  `quantity_produced` int(10) NOT NULL,
...
CREATE TABLE `quality_inspections` (
  ...
  `quantity_inspected` int(10) NOT NULL,
  `quantity_passed` int(10) NOT NULL DEFAULT 0,
  `quantity_failed` int(10) NOT NULL DEFAULT 0,
  `status` varchar(20) NOT NULL DEFAULT 'Pending',
